  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-cream">
        ...
        >
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-3 px-4 bg-whatsapp hover:bg-whatsapp-dark text-white rounded-xl font-medium text-sm transition-colors duration-300"
          >
      ...
      <div className="p-4 md:p-5">
        <p className="text-xs text-beige uppercase tracking-widest mb-1">
          {product.category}
        </p>
        <h3 className="text-charcoal font-medium text-sm md:text-base leading-snug">
          {product.name}
        </h3>
        <p className="mt-1.5 text-beige-dark font-semibold text-sm md:text-base">
          {product.price}
        </p>
      </div>
    </div>
